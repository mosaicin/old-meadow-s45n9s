...
const App = () => {
  ...
  const [selectedPostStranicnost, setSelectedPostStranicnost] = useState('');
  ...
  const handlePostStranicnost = (value) => {
    setSelectedPostStranicnost(value);
  ...
  return (
    <div className="flex flex-col justify-center items-center h-screen p-4">
      ...
      <div className="mt-4">
        ...
        {selectedPostStranicnost && (
          <p className="mt-2">Выбрана пост-странность: {selectedPostStranicnost}</p>
        )}
      </div>
